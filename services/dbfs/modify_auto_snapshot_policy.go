...
type ModifyAutoSnapshotPolicyRequest struct {
	*requests.RpcRequest
	TimePoints     *[]string        `position:"Query" name:"TimePoints"  type:"Json"`
	RepeatWeekdays *[]string        `position:"Query" name:"RepeatWeekdays"  type:"Json"`
...
func CreateModifyAutoSnapshotPolicyRequest() (request *ModifyAutoSnapshotPolicyRequest) {
	...
	request.InitWithApiInfo("DBFS", "2020-04-18", "ModifyAutoSnapshotPolicy", "dbfs", "openAPI")
