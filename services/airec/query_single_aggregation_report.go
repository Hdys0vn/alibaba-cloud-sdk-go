...
func CreateQuerySingleAggregationReportRequest() (request *QuerySingleAggregationReportRequest) {
	...
	request.InitWithApiInfo("Airec", "2020-11-26", "QuerySingleAggregationReport", "/v2/openapi/instances/[instanceId]/sync-reports/single-aggregation-report", "airec", "openAPI")
