...
func (client *Client) ListNamespacedConfigMapsWithCallback(request *ListNamespacedConfigMapsRequest, callback func(response *ListNamespacedConfigMapsResponse, err error)) <-chan int {
	...
	err := client.AddAsyncTask(func() {
		var response *ListNamespacedConfigMapsResponse
		var err error
		defer close(result)
		response, err = client.ListNamespacedConfigMaps(request)
...
func CreateListNamespacedConfigMapsRequest() (request *ListNamespacedConfigMapsRequest) {
	request = &ListNamespacedConfigMapsRequest{
		RoaRequest: &requests.RoaRequest{},
	}
	request.InitWithApiInfo("sae", "2019-05-06", "ListNamespacedConfigMaps", "/pop/v1/sam/configmap/listNamespacedConfigMaps", "serverless", "openAPI")
