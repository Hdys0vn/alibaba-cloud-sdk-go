...
// DescribeInstanceSSL invokes the oceanbasepro.DescribeInstanceSSL API synchronously
...
// DescribeInstanceSSLWithChan invokes the oceanbasepro.DescribeInstanceSSL API asynchronously
...
// DescribeInstanceSSLWithCallback invokes the oceanbasepro.DescribeInstanceSSL API asynchronously
...
type DescribeInstanceSSLResponse struct {
	*responses.BaseResponse
	...
	InstanceSSL InstanceSSL `json:"InstanceSSL" xml:"InstanceSSL"`
}
...
func CreateDescribeInstanceSSLRequest() (request *DescribeInstanceSSLRequest) {
	...
	request.InitWithApiInfo("OceanBasePro", "2019-09-01", "DescribeInstanceSSL", "oceanbase", "openAPI")
