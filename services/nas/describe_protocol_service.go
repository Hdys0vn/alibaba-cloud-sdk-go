...
func (client *Client) DescribeProtocolService(request *DescribeProtocolServiceRequest) (response *DescribeProtocolServiceResponse, err error) {
	response = CreateDescribeProtocolServiceResponse()
...
func (client *Client) DescribeProtocolServiceWithChan(request *DescribeProtocolServiceRequest) (<-chan *DescribeProtocolServiceResponse, <-chan error) {
	responseChan := make(chan *DescribeProtocolServiceResponse, 1)
	errChan := make(chan error, 1)
	err := client.AddAsyncTask(func() {
		defer close(responseChan)
		defer close(errChan)
		response, err := client.DescribeProtocolService(request)
		if err != nil {
			errChan <- err
		} else {
...
func (client *Client) DescribeProtocolServiceWithCallback(request *DescribeProtocolServiceRequest, callback func(response *DescribeProtocolServiceResponse, err error)) <-chan int {
	...
	err := client.AddAsyncTask(func() {
		var response *DescribeProtocolServiceResponse
		var err error
		defer close(result)
		response, err = client.DescribeProtocolService(request)
...
type DescribeProtocolServiceRequest struct {
	*requests.RpcRequest
	...
	ProtocolServiceIds string           `position:"Query" name:"ProtocolServiceIds"`
...
type DescribeProtocolServiceResponse struct {
	*responses.BaseResponse
	...
	ProtocolServices []ProtocolService `json:"ProtocolServices" xml:"ProtocolServices"`
}
...
func CreateDescribeProtocolServiceRequest() (request *DescribeProtocolServiceRequest) {
	...
	request.InitWithApiInfo("NAS", "2017-06-26", "DescribeProtocolService", "nas", "openAPI")
...
func CreateDescribeProtocolServiceResponse() (response *DescribeProtocolServiceResponse) {
	response = &DescribeProtocolServiceResponse{
