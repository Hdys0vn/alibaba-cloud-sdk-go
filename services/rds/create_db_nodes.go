...
// CreateDBNodes invokes the rds.CreateDBNodes API synchronously
...
// CreateDBNodesWithChan invokes the rds.CreateDBNodes API asynchronously
...
// CreateDBNodesWithCallback invokes the rds.CreateDBNodes API asynchronously
