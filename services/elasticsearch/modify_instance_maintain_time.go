...
func CreateModifyInstanceMaintainTimeRequest() (request *ModifyInstanceMaintainTimeRequest) {
	...
	request.InitWithApiInfo("elasticsearch", "2017-06-13", "ModifyInstanceMaintainTime", "/openapi/instances/[InstanceId]/actions/modify-maintaintime", "elasticsearch", "openAPI")
