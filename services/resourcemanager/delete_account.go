...
// DeleteAccount invokes the resourcemanager.DeleteAccount API synchronously
...
// DeleteAccountWithChan invokes the resourcemanager.DeleteAccount API asynchronously
...
// DeleteAccountWithCallback invokes the resourcemanager.DeleteAccount API asynchronously
...
type DeleteAccountRequest struct {
	*requests.RpcRequest
	AbandonableCheckId *[]string `position:"Query" name:"AbandonableCheckId"  type:"Json"`
...
func CreateDeleteAccountRequest() (request *DeleteAccountRequest) {
	...
	request.InitWithApiInfo("ResourceManager", "2020-03-31", "DeleteAccount", "", "")
