...
// ListTagKeys invokes the resourcemanager.ListTagKeys API synchronously
...
// ListTagKeysWithChan invokes the resourcemanager.ListTagKeys API asynchronously
...
// ListTagKeysWithCallback invokes the resourcemanager.ListTagKeys API asynchronously
...
type ListTagKeysRequest struct {
	*requests.RpcRequest
	...
	KeyFilter    string           `position:"Query" name:"KeyFilter"`
}
...
func CreateListTagKeysRequest() (request *ListTagKeysRequest) {
	...
	request.InitWithApiInfo("ResourceManager", "2020-03-31", "ListTagKeys", "", "")
