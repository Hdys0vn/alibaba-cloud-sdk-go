...
// ListTagValues invokes the resourcemanager.ListTagValues API synchronously
...
// ListTagValuesWithChan invokes the resourcemanager.ListTagValues API asynchronously
...
// ListTagValuesWithCallback invokes the resourcemanager.ListTagValues API asynchronously
...
type ListTagValuesRequest struct {
	*requests.RpcRequest
	...
	ValueFilter  string           `position:"Query" name:"ValueFilter"`
...
func CreateListTagValuesRequest() (request *ListTagValuesRequest) {
	...
	request.InitWithApiInfo("ResourceManager", "2020-03-31", "ListTagValues", "", "")
