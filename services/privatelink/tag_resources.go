...
// TagResources invokes the privatelink.TagResources API synchronously
...
// TagResourcesWithChan invokes the privatelink.TagResources API asynchronously
...
// TagResourcesWithCallback invokes the privatelink.TagResources API asynchronously
...
func CreateTagResourcesRequest() (request *TagResourcesRequest) {
	...
	request.InitWithApiInfo("Privatelink", "2020-04-15", "TagResources", "privatelink", "openAPI")
