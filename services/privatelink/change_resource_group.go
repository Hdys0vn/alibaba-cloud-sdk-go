...
// ChangeResourceGroup invokes the privatelink.ChangeResourceGroup API synchronously
...
// ChangeResourceGroupWithChan invokes the privatelink.ChangeResourceGroup API asynchronously
...
// ChangeResourceGroupWithCallback invokes the privatelink.ChangeResourceGroup API asynchronously
...
func CreateChangeResourceGroupRequest() (request *ChangeResourceGroupRequest) {
	...
	request.InitWithApiInfo("Privatelink", "2020-04-15", "ChangeResourceGroup", "privatelink", "openAPI")
