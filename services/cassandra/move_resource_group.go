...
// MoveResourceGroup invokes the cassandra.MoveResourceGroup API synchronously
...
// MoveResourceGroupWithChan invokes the cassandra.MoveResourceGroup API asynchronously
...
// MoveResourceGroupWithCallback invokes the cassandra.MoveResourceGroup API asynchronously
...
func CreateMoveResourceGroupRequest() (request *MoveResourceGroupRequest) {
	...
	request.InitWithApiInfo("Cassandra", "2019-01-01", "MoveResourceGroup", "Cassandra", "openAPI")
